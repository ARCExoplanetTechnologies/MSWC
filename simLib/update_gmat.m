function [Gmat] = generate_gmat(system, sourceNum, DMnum, makeNewGmat, actList, runNum, simOptions)
...
if makeNewGmat
     for iPoke = 1:length(actList),            
        thisAct = actList(iPoke);
        ...
        for iLambda = 1:length(lambdaCor)            
            ...
            EinfluenceCell(iLambda,thiAct,:) = sweepDelta(CorEle)/sqrt(I00);           
