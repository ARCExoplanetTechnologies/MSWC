function [illumination,illuminationOptics] = initialize_illumination_nutek_offaxis(system,x,y)
...
if system.illumParams.illumination.downsample == true
    ...
    system.optics.elem(3).surfaceAberrations = fitsread(system.params.illumination.nuTekSag1);
    system.optics.elem(5).surfaceAberrations = fitsread(system.params.illumination.nuTekSag2);
    system.optics.elem(6).surfaceAberrations = fitsread(system.params.illumination.auxOptics);
end
